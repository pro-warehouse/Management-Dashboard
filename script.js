...
const dataLabelPlugin = {
    ...
    afterDatasetsDraw(chart) {
        ...
        // วาดผลรวม (Grand Total) ไว้บนยอดของกราฟ Stacked Bar (ffmTrendChart)
...
function renderOnTimeSection() {
    ...
    if (ontimeChartInstance) {
        ...
        ontimeChartInstance.data.datasets[0].label = otType + ' %'; ontimeChartInstance.data.datasets[0].borderColor = otType === 'HUB' ? primaryBlue : accentGreen;
